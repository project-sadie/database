...
--
-- Table structure for table `player_navigator_settings`
--

DROP TABLE IF EXISTS `player_navigator_settings`;
...
--
-- Dumping data for table `player_navigator_settings`
--

LOCK TABLES `player_navigator_settings` WRITE;
/*!40000 ALTER TABLE `player_navigator_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `player_navigator_settings` ENABLE KEYS */;
UNLOCK TABLES;

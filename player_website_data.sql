...
--
-- Table structure for table `player_website_data`
--

DROP TABLE IF EXISTS `player_website_data`;
...
--
-- Dumping data for table `player_website_data`
--

LOCK TABLES `player_website_data` WRITE;
/*!40000 ALTER TABLE `player_website_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `player_website_data` ENABLE KEYS */;
UNLOCK TABLES;

...
CREATE TABLE `player_relationships` (
  ...
  CONSTRAINT `player_relationships_origin_player_id_foreign` FOREIGN KEY (`origin_player_id`) REFERENCES `players` (`id`),
  CONSTRAINT `player_relationships_target_player_id_foreign` FOREIGN KEY (`target_player_id`) REFERENCES `players` (`id`),
  CONSTRAINT `player_relationships_type_id_foreign` FOREIGN KEY (`type_id`) REFERENCES `player_relationship_types` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `player_relationships`
--

...
--
-- Table structure for table `player_room_likes`
--

DROP TABLE IF EXISTS `player_room_likes`;
...
--
-- Dumping data for table `player_room_likes`
--

LOCK TABLES `player_room_likes` WRITE;
/*!40000 ALTER TABLE `player_room_likes` DISABLE KEYS */;
/*!40000 ALTER TABLE `player_room_likes` ENABLE KEYS */;
UNLOCK TABLES;

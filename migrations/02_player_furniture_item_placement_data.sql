CREATE TABLE `player_furniture_item_placement_data` (
  ...
  CONSTRAINT `pfipd_item_id_foreign` FOREIGN KEY (`player_furniture_item_id`) REFERENCES `player_furniture_items` (`id`),
  KEY `pfipd_room_id_foreign` (`room_id`),
  CONSTRAINT `pfipd_room_id_foreign` FOREIGN KEY (`room_id`) REFERENCES `rooms` (`id`)

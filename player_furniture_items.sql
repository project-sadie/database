...
--
-- Table structure for table `player_furniture_items`
--

DROP TABLE IF EXISTS `player_furniture_items`;
...
--
-- Dumping data for table `player_furniture_items`
--

LOCK TABLES `player_furniture_items` WRITE;
/*!40000 ALTER TABLE `player_furniture_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `player_furniture_items` ENABLE KEYS */;
UNLOCK TABLES;

...
--
-- Table structure for table `player_respects`
--

DROP TABLE IF EXISTS `player_respects`;
...
--
-- Dumping data for table `player_respects`
--

LOCK TABLES `player_respects` WRITE;
/*!40000 ALTER TABLE `player_respects` DISABLE KEYS */;
/*!40000 ALTER TABLE `player_respects` ENABLE KEYS */;
UNLOCK TABLES;

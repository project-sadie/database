...
--
-- Table structure for table `catalog_front_page_items`
--

DROP TABLE IF EXISTS `catalog_front_page_items`;
...
--
-- Dumping data for table `catalog_front_page_items`
--

LOCK TABLES `catalog_front_page_items` WRITE;
/*!40000 ALTER TABLE `catalog_front_page_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `catalog_front_page_items` ENABLE KEYS */;
UNLOCK TABLES;

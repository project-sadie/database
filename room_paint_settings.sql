...
--
-- Table structure for table `room_paint_settings`
--

DROP TABLE IF EXISTS `room_paint_settings`;
...
--
-- Dumping data for table `room_paint_settings`
--

LOCK TABLES `room_paint_settings` WRITE;
/*!40000 ALTER TABLE `room_paint_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `room_paint_settings` ENABLE KEYS */;
UNLOCK TABLES;

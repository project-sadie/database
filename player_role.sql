...
CREATE TABLE `player_role` (
  ...
  CONSTRAINT `player_role_player_id_foreign` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`),
  CONSTRAINT `player_role_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`)

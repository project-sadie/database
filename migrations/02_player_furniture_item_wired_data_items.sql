CREATE TABLE `player_furniture_item_wired_data_items` (
    ...
    PRIMARY KEY (`id`),
    KEY `pfiwdi_player_furniture_item_placement_data_id_foreign` (`player_furniture_item_placement_data_id`),
    KEY `pfiwdi_duo_index` (
        `player_furniture_item_wired_data_id`, `player_furniture_item_placement_data_id`
    ),
    CONSTRAINT `pfiwdi_player_furniture_item_placement_data_id_foreign` FOREIGN KEY (

...
--
-- Table structure for table `player_game_settings`
--

DROP TABLE IF EXISTS `player_game_settings`;
...
--
-- Dumping data for table `player_game_settings`
--

LOCK TABLES `player_game_settings` WRITE;
/*!40000 ALTER TABLE `player_game_settings` DISABLE KEYS */;
/*!40000 ALTER TABLE `player_game_settings` ENABLE KEYS */;
UNLOCK TABLES;

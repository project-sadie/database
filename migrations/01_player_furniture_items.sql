CREATE TABLE `player_furniture_items` (
    ...
    KEY `player_furniture_items_furniture_item_id_foreign` (
        `furniture_item_id`
    ),
    CONSTRAINT `player_furniture_items_furniture_item_id_foreign` FOREIGN KEY (
        `furniture_item_id`
    ) REFERENCES `furniture_items` (`id`),
    CONSTRAINT `player_furniture_items_player_id_foreign` FOREIGN KEY (
        `player_id`
